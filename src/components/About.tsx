...
const teamMembers = ["Rafael", "Johann", "Anton", "Ole", "Niclas", "Adrian"];
          ...
          <Card className="border-border">
            <CardContent className="pt-6">
              <p className="text-base leading-relaxed text-muted-foreground mb-6">
                Wir als Schülerfirma sind seit dem 6. Januar 2025 aktiv und bestehen im Moment aus 6 Mitgliedern. 
                Wir haben es uns zur Aufgabe gemacht Lehrern, Schülern und Eltern bei allen möglichen technischen 
                Problemen zu helfen.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground mb-6">
                Bei Webseite-Designs, Präsentation-Designs, Problemen mit Hard- und Software, Problemen mit 
                Programmen wie Word, Spotify, Canva oder anderen technischen Angelegenheiten stehen wir für Sie 
                zur Verfügung.
              </p>
